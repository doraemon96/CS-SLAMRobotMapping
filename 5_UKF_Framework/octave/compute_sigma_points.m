...
sigma_matrix = sqrt((n+lambda)*sigma);

sigma_points(1:n,1) = mu;
for i = 2:n+1
  sigma_points(1:n,i) = mu + sigma_matrix(1:n,i-1);
endfor

for i = n+2:2*n+1
  sigma_points(1:n,i) = mu - sigma_matrix(1:n,(i-1)-n);
endfor
